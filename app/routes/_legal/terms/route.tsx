...
export const meta: Route.MetaFunction = ({ matches }) => {
  return [
    { title: "Terms of Use - ImgVid" },
    {
      name: "description",
      content:
        "Review the Terms of Use for ImgVid, outlining the rules, rights, and responsibilities when using our AI-powered character creation platform.",
    },
