...
interface ColorBlurBgProps {
  withOverlay?: boolean;
}
export function ColorBlurBg({ withOverlay = true }: ColorBlurBgProps) {
  return (
    <Fragment>
      {withOverlay && (
        <div className="absolute inset-0 bg-base-200 bg-gradient-to-b from-base-200 via-base-100 to-base-100"></div>
      )}
      <svg
